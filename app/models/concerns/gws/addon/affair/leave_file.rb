module Gws::Addon::Affair::LeaveFile
  ...
  included do
    ...
    before_validation :validate_compensatory_file

    validates :leave_type, presence: true
    validates :start_at, presence: true, datetime: true
    validates :end_at, presence: true, datetime: true
    validates :week_in_compensatory_file_id, presence: true, uniqueness: true, if: ->{ leave_type == "week_in_compensatory_leave" }
    validates :week_out_compensatory_file_id, presence: true, uniqueness: true, if: ->{ leave_type == "week_out_compensatory_leave" }
